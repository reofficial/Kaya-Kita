...
import 'govissue2.dart';

class EmergencyContactCertificationScreen extends StatefulWidget {
  final Map<String, dynamic> workerData;
  final Map<String, dynamic> certificationData;

  const EmergencyContactCertificationScreen({
    super.key,
  ...
  @override
  _EmergencyContactCertificationScreenState createState() => _EmergencyContactCertificationScreenState();
}

class _EmergencyContactCertificationScreenState extends State<EmergencyContactCertificationScreen> {
  ...
  void onNext() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GovIssueCertificationScreen(
