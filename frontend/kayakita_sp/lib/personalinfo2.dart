...
class PersonalCertificationInfoScreen extends StatefulWidget {
  ...
  const PersonalCertificationInfoScreen({
    super.key,
    required this.email,
  ...
  @override
  _PersonalCertificationInfoScreenState createState() => _PersonalCertificationInfoScreenState();
}

class _PersonalCertificationInfoScreenState extends State<PersonalCertificationInfoScreen> {
  ...
  void onContinue() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ApplicationCertificationScreen(workerData: workerData),
      ),
    );
  }
